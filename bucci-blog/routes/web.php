...
Route::get('/admin/post/headerpost', [App\Http\Controllers\AdminController::class, 'headerpost'])->name('admin.headerpost');
Route::get('/admin/post/mainpost', [App\Http\Controllers\AdminController::class, 'mainpost'])->name('admin.mainpost');
Route::get('/admin/post/sidepost', [App\Http\Controllers\AdminController::class, 'sidepost'])->name('admin.sidepost');
